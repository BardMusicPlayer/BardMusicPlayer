...
namespace BardMusicPlayer.Updater.Util
{
    internal static class Loader
    {
        ...
        internal static async Task<bool> Load(BmpVersion version, string exePath, string resourcePath, string dataPath,
            string[] cliParameters)
        {
            ...
            return await main.StartUp(version.beta, version.build, version.commit, exePath, resourcePath, dataPath,
                cliParameters);
        }
    }
}