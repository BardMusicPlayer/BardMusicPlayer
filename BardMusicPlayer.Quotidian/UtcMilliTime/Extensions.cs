...
namespace BardMusicPlayer.Quotidian.UtcMilliTime
{
    public static class Extensions
    {
        ...
        public static long ToUtcMilliTime(this DateTime given) =>
            given.ToUniversalTime().Ticks / Constants.dotnet_ticks_per_millisecond -
        ...
        public static int IntervalHoursPart(this long interval) =>
            (int) (interval % Constants.day_milliseconds) / Constants.hour_milliseconds;
        ...
        public static int IntervalMinutesPart(this long interval) =>
            (int) (interval - (interval.IntervalDays() * Constants.day_milliseconds +
        ...
        /// <param name="interval">UtcMilliTime</param>
        /// <returns>int</returns>
        public static int IntervalSecondsPart(this long interval) => (int) (interval -
                                                                            (interval.IntervalDays() *
                                                                             Constants.day_milliseconds +
                                                                             interval.IntervalHoursPart() *
                                                                             Constants.hour_milliseconds +
                                                                             interval.IntervalMinutesPart() *
                                                                             Constants.minute_milliseconds)) /
        ...
        public static DateTime ToUtcDateTime(this long timestamp) =>
            new DateTime(1970, 1, 1, 0, 0, 0, DateTimeKind.Utc).AddMilliseconds(timestamp);
