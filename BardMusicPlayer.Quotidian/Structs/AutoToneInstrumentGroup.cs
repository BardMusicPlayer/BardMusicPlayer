...
namespace BardMusicPlayer.Quotidian.Structs
{
    ...
    public readonly struct AutoToneInstrumentGroup : IComparable, IConvertible, IComparable<AutoToneInstrumentGroup>, IEquatable<AutoToneInstrumentGroup>
    {
        ...
        public static readonly AutoToneInstrumentGroup Tuba1Trombone2Trumpet2 = new("Tuba1Trombone2Trumpet2", 305, 1, 2, 2, InstrumentTone.Brass, Instrument.Tuba, Instrument.Trombone, Instrument.Trumpet, AutoToneOctaveRange.C1toC6);
        public static readonly IReadOnlyList<AutoToneInstrumentGroup> TubaTromboneTrumpet = new ReadOnlyCollection<AutoToneInstrumentGroup>(new List<AutoToneInstrumentGroup> { Tuba1Trombone3Trumpet1, Tuba2Trombone2Trumpet1, Tuba3Trombone1Trumpet1, Tuba2Trombone1Trumpet2, Tuba1Trombone1Trumpet3, Tuba1Trombone2Trumpet2 });
        ...
        public static readonly AutoToneInstrumentGroup Tuba1Horn2Trumpet2 = new("Tuba1Horn2Trumpet2", 311, 1, 2, 2, InstrumentTone.Brass, Instrument.Tuba, Instrument.Horn, Instrument.Trumpet, AutoToneOctaveRange.C1toC6);
        public static readonly IReadOnlyList<AutoToneInstrumentGroup> TubaHornTrumpet = new ReadOnlyCollection<AutoToneInstrumentGroup>(new List<AutoToneInstrumentGroup> { Tuba1Horn3Trumpet1, Tuba2Horn2Trumpet1, Tuba3Horn1Trumpet1, Tuba2Horn1Trumpet2, Tuba1Horn1Trumpet3, Tuba1Horn2Trumpet2 });
        ...
        public static readonly AutoToneInstrumentGroup Tuba1Trombone2Saxophone2 = new("Tuba1Trombone2Saxophone2", 319, 1, 2, 2, InstrumentTone.Brass, Instrument.Tuba, Instrument.Trombone, Instrument.Saxophone, AutoToneOctaveRange.C1toC6);
        public static readonly IReadOnlyList<AutoToneInstrumentGroup> TubaTromboneSaxophone= new ReadOnlyCollection<AutoToneInstrumentGroup>(new List<AutoToneInstrumentGroup> { Tuba1Trombone3Saxophone1, Tuba2Trombone2Saxophone1, Tuba3Trombone1Saxophone1, Tuba2Trombone1Saxophone2, Tuba1Trombone1Saxophone3, Tuba1Trombone2Saxophone2 });
        ...
        public static readonly AutoToneInstrumentGroup Tuba1Horn2Saxophone2 = new("Tuba1Horn2Saxophone2", 325, 1, 2, 2, InstrumentTone.Brass, Instrument.Tuba, Instrument.Horn, Instrument.Saxophone, AutoToneOctaveRange.C1toC6);
        public static readonly IReadOnlyList<AutoToneInstrumentGroup> TubaHornSaxophone = new ReadOnlyCollection<AutoToneInstrumentGroup>(new List<AutoToneInstrumentGroup> { Tuba1Horn3Saxophone1, Tuba2Horn2Saxophone1, Tuba3Horn1Saxophone1, Tuba2Horn1Saxophone2, Tuba1Horn1Saxophone3, Tuba1Horn2Saxophone2 });
