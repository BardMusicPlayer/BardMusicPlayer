...
namespace BardMusicPlayer.Pigeonhole.JsonSettings.Inline
{
    ...
    {
        public static IEnumerable<ConstructorInfo> GetAllConstructors(this Type t) => t.GetConstructors()
            .Concat(t.GetConstructors(BindingFlags.NonPublic | BindingFlags.Instance));
