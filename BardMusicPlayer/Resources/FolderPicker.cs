...
public class FolderPicker
{
    ...
    private static string? OkButtonLabel => null;

    private static string? FileNameLabel => null;

    private static int SetOptions(int options)
    {
        if (ForceFileSystem)
        {
    ...
    // for all .NET
    protected virtual bool? ShowDialog(IntPtr owner, bool throwOnError = false)
    {
