...
namespace BardMusicPlayer.Siren.AlphaTab
{
    internal static class Platform
    {
        ...
        public static bool IsCharNumber(int c, bool allowSign = true) =>
            allowSign && c == 0x2D || c >= 0x30 && c <= 0x39;

        public static bool IsWhiteSpace(int c) => c == 0x20 || c == 0x0B || c == 0x0D || c == 0x0A || c == 0x09;

        public static bool IsAlmostEqualTo(this float a, float b) => Math.Abs(a - b) < 0.00001f;
        ...
        public static uint ToUInt32(int i) => (uint) i;

        public static short ToInt16(int i) => (short) i;

        public static ushort ToUInt16(int i) => (ushort) i;

        public static byte ToUInt8(int i) => (byte) i;
        ...
        public static float Log2(float s) => (float) Math.Log(s, 2);
        ...
        public static int[] CloneArray(int[] array) => (int[]) array.Clone();
        ...
        public static string StringFromCharCode(int c) => ((char) c).ToString();

        public static sbyte ReadSignedByte(this IReadable readable) => unchecked((sbyte) (byte) readable.ReadByte());
        ...
        public static void ClearIntArray(int[] array) { Array.Clear(array, 0, array.Length); }
        ...
        public static long GetCurrentMilliseconds() => Stopwatch.GetTimestamp();
    }
}