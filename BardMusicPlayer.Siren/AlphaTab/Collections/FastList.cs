...
namespace BardMusicPlayer.Siren.AlphaTab.Collections
{
    ...
    internal class FastList<T> : IEnumerable<T>
    {
        ...
        private FastList(IEnumerable<T> collection) { _list = new List<T>(collection); }
        ...
        /// </summary>
        /// <returns></returns>
        public FastList<T> Clone() => new(this);
        ...
        public void InsertAt(int insertPos, T item) { _list.Insert(insertPos, item); }
