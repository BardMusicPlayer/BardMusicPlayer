...
namespace BardMusicPlayer.Siren.AlphaTab.Audio
{
    internal static class MidiUtils
    {
        ...
        public static int TicksToMillis(int ticks, int tempo) => (int) (ticks * (60000.0 / (tempo * QuarterTime)));
        ...
        public static int MillisToTicks(int millis, int tempo) => (int) (millis / (60000.0 / (tempo * QuarterTime)));
        ...
        /// <returns></returns>
        public static int ToTicks(this Duration duration) => ValueToTicks((int) duration);
        ...
        public static int ApplyTuplet(int ticks, int numerator, int denominator) => ticks * denominator / numerator;

        public static int RemoveTuplet(int ticks, int numerator, int denominator) => ticks * numerator / denominator;

        public static int DynamicToVelocity(DynamicValue dyn) => MinVelocity + (int) dyn * VelocityIncrement;
    }
}